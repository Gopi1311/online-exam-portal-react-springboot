...
useEffect(()=>{
  ...
  return (
    <div className="d-flex vh-100  justify-content-center align-items-center" style={{backgroundColor:'#c1e8ff'}}>
    <div className="w-25 bg-white rounded p-3 shadow-lg">
    <h2 className="border-bottom pb-2 d-flex justify-content-center">Teacher Detail</h2>
      ...
      <Link to="/teacherhomedash" className="btn btn-primary ">Back</Link>
